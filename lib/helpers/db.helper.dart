...
import "package:expense_tracker/helpers/migrations/migrations.dart";
...
Future<void> resetDatabase() async {
  ...
  List<Map<String, dynamic>> categories = [
    {"name": "Housing", "icon": Icons.house_rounded},
    {"name": "Transportation", "icon": Icons.car_rental_rounded},
